...
def main():
    ...
    st.sidebar.image("cummins.png", use_column_width=False)
    st.header("💬 Chatbot")
...
def handel_userinput(user_question):
    ...
    with response_container:
        ...
        st.write(f"Total Tokens: {cb.total_tokens}" f", Prompt Tokens: {cb.prompt_tokens}" f", Completion Tokens: {cb.completion_tokens}" f", Total Cost (USD): ${round(cb.total_cost,4)}")
